...
class evade_fw:
	def decoy_address(self):
		...
		if ports == "":
			...
			print("Now going to run nmap scan -D RND:10,192.168.1.103,10.0.0.129,ME -sV -Pn -p " + ports + " and version detection options, saving output to decoy-" + ip + ".nmap and decoy-" + ip + ".xml for later parsing.")
